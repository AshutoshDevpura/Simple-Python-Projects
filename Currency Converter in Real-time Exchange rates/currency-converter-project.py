...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        self.date_label = Label(self, text = f"1 INR equals = {self.currency_converter.convert('INR','USD',1)} USD \n Date : {self.currency_converter.data['date']}", relief = tk.GROOVE, borderwidth = 5)
        ...
        self.amount_field.place(x = 25, y = 150)
        self.to_currency_dropdown.place(x = 335, y= 120)
        self.converted_amount_field_label.place(x = 335, y = 150)
        
        # Convert button
        self.convert_button = Button(self, text = "Convert", fg = "black", command = self.perform) 
        self.convert_button.config(font=('Courier', 10, 'bold'))
        self.convert_button.place(x = 250, y = 175)
   ...
   #The perform method will take the user input and convert the amount into the desired currency and display it on the converted_amount entry box.
    ...
    #The restricNumberOnly method will restrict user to enter number only
